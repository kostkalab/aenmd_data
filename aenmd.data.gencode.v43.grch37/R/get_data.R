...
#=============================================
#- GENCODE 43 human on GRCh37
gtff <- 'https://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_43/GRCh37_mapping/gencode.v43lift37.annotation.gtf.gz'
...
txdb <- GenomicFeatures::makeTxDbFromGFF( file = BiocFileCache::bfcrpath(BiocFileCache::BiocFileCache(), gtff),
					  ...
					  circ_seqs = 'chrM',
					  chrominfo = BSgenome::seqinfo(BSgenome.Hsapiens.UCSC.hg19::Hsapiens))
...
#- [1] 19926  about 20k protein-coding genes.
...
###########################################################################
saveRDS(CDS_TO_TX,   file = paste0(PREFIX, "/gr_gencode_v43_txs-mask.rds"))
###########################################################################
...
########################################################################
saveRDS(SPL_MSK,   file = paste0(PREFIX, "/extdata/gr_gencode_v43_spl-mask.rds"))
########################################################################
